...
public class DishTestData {
    ...
    public static final Dish DISH3 = new Dish(DISH1_ID + 2, "Hamburger", 30, "Hamburger Ingredients", State.STATE_ACTIVE);
    ...
    public static final Dish DISH6 = new Dish(DISH1_ID + 5, "Sandwich", 20, "Sandwich Ingredients", State.STATE_ACTIVE);
    ...
    public static Dish getUpdated() {
        return new Dish(DISH1_ID, "Updated Cheeseburger", 11, "Cheeseburger Ingredients", State.STATE_ACTIVE);
    }
